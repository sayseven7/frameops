...
`down -v`, `--remove-orphans` e exclusão de volumes não fazem parte deste
contrato. O launcher `scripts/local-runtime.sh` aplica o mesmo teardown
preservador ao seu projeto isolado.
